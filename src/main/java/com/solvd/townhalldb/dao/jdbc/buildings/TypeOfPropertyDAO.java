...
public class TypeOfPropertyDAO extends AbstractJdbcDao implements ITypeOfPropertyDAO {
    ...
    @Override
    public void create(TypeOfProperty typeOfProperty) {
        Connection c = null;
    ...
    @Override
    public void update(TypeOfProperty typeOfProperty) {
        Connection c = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
        try {
    ...
    @Override
    public TypeOfProperty getById(long id) {
        Connection c = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    @Override
    public void delete(TypeOfProperty typeOfProperty) {
        Connection c = null;
        PreparedStatement ps = null;
